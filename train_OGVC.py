...
def main():
	parser = argparse.ArgumentParser(description='Pytorch example: OGVC')
	...
	trainvalset = OGVCDataset(root=args.dataset, train=True, transform=transform)
	# Split train/val
	...
	plt.savefig(args.out + '/accuracy_OGVC.png')
	#plt.show()
